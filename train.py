...
from models import SupResNet, SSLResNet, SupConResNet
# from models1 import resnet50
import data
import trainers
...
def main():
    ...
    # Create model
    if args.training_mode in ["SimCLR"]:
        ...
        model = SupConResNet(name = args.arch).to(device)
    else:
