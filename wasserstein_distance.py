...
#x = torch.tensor(ssl_features_train[30:130], dtype = torch.float32)
x = torch.tensor(ssl_features_ood[30:130], dtype = torch.float32)
y = torch.tensor(sl_features_2[30:130], dtype = torch.float32)
#x = torch.tensor(sl_normal_feature[:100], dtype = torch.float32)
#y = torch.tensor(ssl_normal_feature[:100], dtype = torch.float32)
#print(y.size())
...
#lp_dist = sample_align_distance(ssl_features_train[:100], sl_features_2[:100], p = 2)
lp_dist = sample_align_distance(ssl_features_ood[:100], sl_features_2[:100], p = 2)
#lp_dist = sample_align_distance(sl_normal_feature[:100], ssl_normal_feature[:100], p = 2)
print("Sample_LP distance:", np.mean(lp_dist))
#w_dist = wasserstein_distance(sl_features_train[:100], ssl_features_train[:100])
#print("Wasserstein distance:", w_dist)
lp_dist = sample_align_distance(sl_features_train[:100], ssl_features_train[:100], p = 2)
#lp_dist = sample_align_distance(sl_normal_feature[:100], ssl_normal_feature[:100], p = 10)
print("Sample_LP distance:", np.mean(lp_dist))
#print("Sample_Cosine distance:", np.mean(cosine_dist))
