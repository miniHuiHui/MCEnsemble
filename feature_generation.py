...
def main():
    ...
    np.save("./models/resnet18_cifar10/features11/features_train2.npy",features_train)
    np.save("./models/resnet18_cifar10/features11/labels_train2.npy",labels_train)
   # np.save("./features_all/supervised_contrastive_IM1K_vs_CIFAR100/features_train2.npy",features_train)
   # np.save("./features_all/supervised_contrastive_IM1K_vs_CIFAR100/labels_train2.npy",labels_train)

    features_test, labels_test = get_features(model.encoder, test_loader)
   # np.save("./features_all/supervised_contrastive_IM1K_vs_CIFAR100/features_test.npy",features_test)
    np.save("./models/resnet18_cifar10/features11/features_test.npy",features_test)
    np.save("./models/resnet18_cifar10/features11/labels_test.npy",labels_test)
    ...
    #np.save("./features_all/supervised_contrastive_cifar10/test_1st_block.npy", Feature1_test)
    #np.save("./features_all/supervised_contrastive_cifar10/test_2nd_block.npy", Feature2_test)
    #np.save("./features_all/supervised_contrastive_cifar10/test_3rd_block.npy", Feature3_test)
    ...
    for d in ds:
        ...
        np.save("./models/resnet18_cifar10/features11/features_ood.npy",features_ood)
        ...
        np.save("./models/resnet18_cifar10/features11/labels_ood.npy", labels_ood)
