...
def cifar10(
    ...
    testset_1 = torch.utils.data.Subset(testset, subset)
...
def imagenet1k(
    data_dir, batch_size=32, mode="base", normalize=True, norm_layer=None, size=(32,32)
):
    """
    mode: org | base | ssl
    """
...
#        download=True,
    ...
    train_loader = DataLoader(
        trainset, batch_size=batch_size, shuffle=False, num_workers=16, pin_memory=True
    )
    test_loader = DataLoader(
...
def svhn(data_dir, batch_size=32, mode="base", normalize=True, norm_layer=None, size=32):
    """
    mode: org | base | ssl
    """
    transform_train = [
